    ...
    <div className={`layout ${sidebarCollapsed ? "sidebar-collapsed" : ""}`}>
      <aside className="sidebar">
        <div className="sidebar-brand">
          ...
          />
          {!sidebarCollapsed && <BalanceBadge onClick={() => goTo("recharge")} />}
          <button
        ...
        <div className="sidebar-footer">
          ...
          />
          {!sidebarCollapsed && onSignInClick && (
      ...
      <main className="content">
        ...
        {visitedViews.has("recharge") && (
          <div style={paneStyle("recharge")}>
            <RechargePage />
          </div>
        )}

        {visitedViews.has("orders") && (
          <div style={paneStyle("orders")}>
            <OrderHistoryPage />
          </div>
        )}
