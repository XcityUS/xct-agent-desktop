export default {
  ...
  walletSection: "钱包",
  walletConnected: "已连接",
  walletHint: "粘贴你在 xcity.one 生成的长效访问令牌，用于充值、订单历史和余额显示。",
  walletJwtPlaceholder: "eyJhbGc...（从 xcity.one 复制粘贴）",
  walletJwtEmpty: "令牌不能为空",
  walletConnect: "连接钱包",
  walletConnecting: "连接中…",
  walletDisconnect: "断开钱包",
  walletConnectedMsg: "钱包已连接",
  walletDisconnectedMsg: "钱包已断开",
  dataSection: "数据",
