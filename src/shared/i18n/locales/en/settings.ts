export default {
  ...
  customApiKeyHint:
    "Bearer token for the custom endpoint (leave blank for local servers that don't require auth)",
  poolHint:
  ...
  walletHint:
    "Paste the long-lived access token you generated at xcity.one to enable Recharge, Order History, and balance display.",
  walletJwtPlaceholder: "eyJhbGc... (paste from xcity.one)",
  walletJwtEmpty: "Token cannot be empty",
  walletConnect: "Connect wallet",
  walletConnecting: "Connecting…",
  walletDisconnect: "Disconnect wallet",
  walletConnectedMsg: "Wallet connected",
  walletDisconnectedMsg: "Wallet disconnected",
  dataSection: "Data",
  dataHint:
