export default {
  ...
  walletHint:
    "Pega el token de acceso que generaste en xcity.one para habilitar la recarga, el historial de órdenes y la visualización del saldo.",
  walletJwtPlaceholder: "eyJhbGc... (pegar desde xcity.one)",
  walletJwtEmpty: "El token no puede estar vacío",
  walletConnect: "Conectar billetera",
  walletConnecting: "Conectando…",
  walletDisconnect: "Desconectar billetera",
  walletConnectedMsg: "Billetera conectada",
  walletDisconnectedMsg: "Billetera desconectada",
  dataSection: "Datos",
  dataHint:
